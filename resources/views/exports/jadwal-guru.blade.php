...
<head>
    ...
    <style>
        ...
        .kelas { color: #475569; font-size: 10px; font-weight: bold; }
...
@foreach($entities as $index => $guru)
    @if($index > 0)
    ...
    <div class="title">Jadwal Guru: {{ $guru->nama }}</div>
                ...
                <tr>
                    ...
                    @foreach(['Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu'] as $hari)
                        ...
                        @if($jam)
                            ...
                            @else
                                <td>
                                    @if(isset($jadwalGrouped[$guru->id][$hari][$jam->id]))
                                        @foreach($jadwalGrouped[$guru->id][$hari][$jam->id] as $j)
